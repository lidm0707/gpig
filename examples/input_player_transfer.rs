...
impl Workspace {
    ...
    fn save_to_player1(&mut self, _: &MouseUpEvent, _window: &mut Window, cx: &mut Context<Self>) {
        // Get text from the input and save to player1
        let name = self.text_input.read(cx).get_text();
    ...
    fn transfer_name(&mut self, _: &MouseUpEvent, _window: &mut Window, cx: &mut Context<Self>) {
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child("Player Name Transfer with Text Input"),
            )
            .child(
                div()
                    .flex()
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .child("Save to Player 1")
                                    .on_mouse_up(
                                        MouseButton::Left,
                                        cx.listener(Self::save_to_player1),
                                    ),
                            )
                            .child(
                                div()
                                    ...
                                    .on_mouse_up(
                                        MouseButton::Left,
                                        cx.listener(Self::transfer_name),
                                    ),
                            ),
                    ),
            )
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .rounded_md()
                                    .text_color(rgb(0xffffff))
                                    .child(if player1_name.is_empty() {
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .rounded_md()
                                    .text_color(rgb(0xffffff))
                                    .child(if player2_name.is_empty() {
                                        "No name transferred".to_string()
                                    } else {
                                        player2_name
                                    }),
                            ),
            ...
            .open_window(
                ...
                |_window, cx| {
                    ...
                    let text_input = cx.new(|cx| TextInput {
                        focus_handle: cx.focus_handle(),
                        content: "".into(),
                        placeholder: "Type a name here...".into(),
                        selected_range: 0..0,
                    ...
                    // Create workspace with all components
                    cx.new(|cx| Workspace::new(text_input, player1, player2, cx))
                },
            )
            .unwrap();
