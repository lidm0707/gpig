...
use gpui::{
    ...
    UTF16Selection, UnderlineStyle, Window, actions, div, fill, hsla, point, px, relative, rgba,
    size,
};
...
impl TextInput {
    ...
    fn on_mouse_down(
        ...
        if event.modifiers.shift {
            ...
            self.move_to(self.index_for_mouse(event.position), cx)
        }
    }
...
impl EventEmitter<TextInputSubmitted> for TextInput {}
